      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            {/* 🔥 Используем computed свойство greeting */}
            <p style={{ color: '#8b6b4f' }}>{auth.greeting}</p>
            {/* 🔥 Используем computed свойство userRoleDisplay */}
            <p style={{ fontSize: '14px', color: '#a67b5b' }}>{auth.userRoleDisplay}</p>
          </div>
